...
public class doctorPatientListActivity extends ListActivity {

	private HospitalSqlite m_HospitalSqlite;

	private Intent doctorPatientInfoIntent;
	private String doctorIdNumString;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 初始化人员id
		doctorIdNumString = (String) this.getIntent().getSerializableExtra(
				"userIdNumString");
		...
		patientInfoList = m_HospitalSqlite
				.getPatientInfoOnDoctor(doctorIdNumString);

		// 初始化意图
		doctorPatientInfoIntent = new Intent();

		doctorPatientInfoIntent
				.setComponent(new ComponentName(doctorPatientListActivity.this,
						doctorPatientInfoActivity.class));
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		patientLogonNameString = patientInfoList.get(position).get(1)
				.toString();
		doctorPatientInfoIntent.putExtra("patientLogonNameString",
				patientLogonNameString);
		startActivity(doctorPatientInfoIntent);
